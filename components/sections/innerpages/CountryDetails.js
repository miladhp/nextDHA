					...
					<div className="service-sidebar">
						<div className="sidebar-widget service-sidebar-single">
							<div className="service-sidebar wow fadeInUp"
								...
								<ul>
								<li><Link href="page-service-details" className="current"><i className="fas fa-angle-right"></i><span>USA Visa</span></Link></li>
								<li><Link href="page-service-details"><i className="fas fa-angle-right"></i><span>Canada Visa</span></Link></li>
								<li><Link href="page-service-details"><i className="fas fa-angle-right"></i><span>Germany Visa</span></Link></li>
								<li><Link href="page-service-details"><i className="fas fa-angle-right"></i><span>Spain Visa</span></Link></li>
								<li><Link href="page-service-details"><i className="fas fa-angle-right"></i><span>Italy Visa</span></Link></li>
								<li><Link href="page-service-details"><i className="fas fa-angle-right"></i><span>Japan Visa</span></Link></li>
								</ul>
								</div>
							</div>
						</div>

				...
				<div className="col-xl-8 col-lg-7">
					<div className="blog-details__left">
						...
						<div className="blog-details__content">
							...
							<h3 className="blog-details__title">Reasons for Australian Student Visa Refusal</h3>
						...
						<div className="blog-details__bottom">
							<p className="blog-details__tags"> <span>Tags</span> <Link href="news-details">Immigration</Link> <Link href="news-details">Visa Consultancy</Link> </p>
						...
						<div className="comment-one">
							...
							<div className="comment-one__single">
								<div className="comment-one__image"> <img src="images/resource/testimonial-4.jpg" alt="" /> </div>
								<div className="comment-one__content">
									...
									<Link href="news-details" className="theme-btn btn-style-one bg-theme-color4 comment-one__btn"><span className="btn-title">Reply</span></Link>
								</div>
							</div>
							<div className="comment-one__single">
								<div className="comment-one__image"> <img src="images/resource/testimonial-5.jpg" alt="" /> </div>
								<div className="comment-one__content">
									<h3>Sarah Albert</h3>
									<p>Mauris non dignissim purus, ac commodo diam. Donec sit amet lacinia nulla.
										Aliquam quis purus in justo pulvinar tempor. Aliquam tellus nulla,
					...
					<div className="sidebar">
						...
						<div className="sidebar__single sidebar__category">
							...
							<ul className="sidebar__category-list list-unstyled">
								<li><Link href="news-details">Abroad Study<span
									className="icon-right-arrow"></span></Link> </li>
								<li className="active"><Link href="news-details">Green card<span
									className="icon-right-arrow"></span></Link></li>
								<li><Link href="news-details">PR Applicants<span
									className="icon-right-arrow"></span></Link> </li>
								<li><Link href="news-details">Travel Insurance<span
									className="icon-right-arrow"></span></Link> </li>
								<li><Link href="news-details">Visa Consultancy<span
									className="icon-right-arrow"></span></Link> </li>
								<li><Link href="news-details">Work Permits<span
									className="icon-right-arrow"></span></Link> </li>
							</ul>
						</div>
						<div className="sidebar__single sidebar__tags">
							<h3 className="sidebar__title">Tags</h3>
							<div className="sidebar__tags-list"> <Link href="#">Education</Link> <Link href="#">Visa</Link> <Link href="#">Immigration</Link> <Link href="#">Digital</Link> <Link href="#">Travel</Link> <Link href="#">Language</Link> </div>
						</div>

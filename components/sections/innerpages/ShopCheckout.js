            ...
            <form id="checkout-form" action="#">
              <div className="row mt-30">
                  ...
                  <div className="billing-details">
                    ...
                    <div className="row">
                      <div className="mb-3 col-md-6">
                        <label htmlhtmlFor="checkuot-form-fname">
                          First Name
                        </label>
                        <input
                      ...
                      <div className="mb-3 col-md-6">
                        <label htmlhtmlFor="checkuot-form-lname">
                          Last Name
                        </label>
                        <input
                      ...
                      <div className="col-md-12">
                        <div className="mb-3">
                          <label htmlhtmlFor="checkuot-form-cname">
                            Company Name
                          </label>
                          <input
                        ...
                        <div className="mb-3">
                          <label htmlhtmlFor="checkuot-form-email">
                            Email Address
                          </label>
                          <input
                        ...
                        <div className="mb-3">
                          <label htmlhtmlFor="checkuot-form-address">
                            Address
                          </label>
                          <input
                      ...
                      <div className="mb-3 col-md-6">
                        <label htmlhtmlFor="checkuot-form-city">City</label>
                        <input
                      ...
                      <div className="mb-3 col-md-6">
                        <label htmlhtmlFor="checkuot-form-zip">
                          Zip/Postal Code
                        </label>
                        <input
                ...
                <div className="col-md-6">
                  ...
                  <label htmlhtmlFor="order_comments" className="">
                    Order notes&nbsp;
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="product-name">
                          <Link href="shop-product-details">Headphone</Link> x 2
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td className="product-name">
                          <Link href="shop-product-details">Lagage</Link> x 3
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td className="product-name">
                          <Link href="shop-product-details">Watch</Link> x 1
                        </td>
                        <td>

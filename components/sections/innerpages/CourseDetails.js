              ...
              <div className="courses-details__content">
                ...
                <div className="content mt-40">
                  ...
                  <div className="row mt-30">
                    <div className="feature-block col-sm-6 wow fadeInUp">
                      <div className="inner-box">
                        ...
                        <div className="content">
                          <h4 className="title">
                            <Link href="about">Apply for New Visa Online</Link>
                          </h4>
                          <div className="text">
                    ...
                    <div
                      className="feature-block col-sm-6 wow fadeInUp"
                ...
                <div className="latest-course mb-30">
                  ...
                  <div className="latest-course-item">
                    ...
                    <div className="latest-course-content">
                      ...
                      <h5>
                        <Link href="page-course-details">TOEFL Coaching</Link>
                      </h5>
                  ...
                  <div className="latest-course-item">
                    ...
                    <div className="latest-course-content">
                      ...
                      <h5>
                        <Link href="page-course-details">Citizenship Test</Link>
                      </h5>
                      <div className="latest-course-stars">
                        <i className="fas fa-star"></i>
                        <i className="fas fa-star"></i>
                  ...
                  <div className="latest-course-item">
                    ...
                    <div className="latest-course-content">
                      ...
                      <h5>
                        <Link href="page-course-details">PTE Coaching</Link>
                      </h5>
                      <div className="latest-course-stars">
                        <i className="fas fa-star"></i>
                        <i className="fas fa-star"></i>

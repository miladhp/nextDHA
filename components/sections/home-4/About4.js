    ...
    <>
      <section className="about-section-four">
        <div className="auto-container">
          <div className="row">
            <div
              className="content-column col-xl-6 col-lg-7 col-md-10 col-sm-12 order-lg-2 wow fadeInRight"
            ...
            >
              <div className="inner-column">
                ...
                <div className="row">
                  ...
                  <div className="about-block-four col-md-6">
                    <div className="icon">
                      <i className="flaticon-customs-agent"></i>
                    </div>
                    <h5 className="title">
                      Quick & Easy <br />
                      Process
                ...
                <div className="content-box">
                  <ul className="list-style-one">
                    <li>
                      <i className="icon fas fa-check-circle"></i> Visa
                      Consulting
                    </li>
                    <li>
                      <i className="icon fas fa-check-circle"></i> Immigration
                      Consultancy
                    </li>
                  </ul>
            ...
            <div className="image-column col-xl-6 col-lg-5 col-md-10 col-sm-12">
              <div className="inner-column wow fadeInLeft">
                ...
                <figure className="image-2 overlay-anim wow fadeInRight">
                  <img src="images/resource/about4-2.jpg" alt="" />
                </figure>

      ...
      <div className="row">
          ...
          <div className="inner-column">
            ...
            <div className="content-box">
              <ul className="list-style-one">
                <li><i className="icon fas fa-arrow-alt-circle-right"></i> Make website without </li>
                <li><i className="icon fas fa-arrow-alt-circle-right"></i> Full design freedom for everyone</li>
                <li><i className="icon fas fa-arrow-alt-circle-right"></i> Sed ut perspiciatis unde omnis</li>
                <li><i className="icon fas fa-arrow-alt-circle-right"></i> We denou righteous indigna</li>
              </ul>
              <div className="video-block wow fadeInRight">
                <div className="inner-box">
                  <div className="bg bg-image" style={{backgroundImage: 'url(./images/resource/video-1.jpg)'}}></div>
        ...
        <div className="image-column col-xl-6 col-lg-5 col-md-7 col-sm-12">
          <div className="inner-column wow fadeInLeft">
            ...
            <figure className="image-2 overlay-anim wow fadeInRight"><img src="images/resource/about5-1.jpg" alt="" /></figure>

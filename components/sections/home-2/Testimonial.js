...
const TestimonialSection = () => {
  return (
    ...
    <div className="bg bg-image" style={{ backgroundImage: 'url(./images/icons/bg-shape2.jpg)'}}></div>
    <div className="auto-container">
      <div className="sec-title light text-center"> <span className="sub-title">testimonials</span>
        ...
        <div className="carousel-outer">
          <Swiper {...swiperOptions} className="testimonial-carousel-three owl-carousel owl-theme default-dots">
            ...
            <div className="inner-box">
              <div className="image-box">
                <figure className="thumb"><img src="images/resource/testi2-2.jpg" alt="Image" /></figure>
                <div className="icon-quote"></div>
              </div>
              <div className="content-box">
                <h6 className="reason">Great Service</h6>

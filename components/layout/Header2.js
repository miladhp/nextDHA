          ...
          <div className="inner-container">
            ...
            <div className="top-right">
              <ul className="list-style-one light">
                <li>
                  <i className="fal fa-clock"></i> Monday - Friday: 9.00am -
                  10.00pm
                </li>
                <li>
                  <i className="far fa-map-marker-alt"></i> Richardson,
                  California 62639
                </li>
                <li>
                  <i className="far fa-envelope"></i>{" "}
                  <Link href="mailto:visago@mail.com">visago@mail.com</Link>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="header-lower">
          <div className="main-box">
            <div className="logo-box">
              <div className="logo">
                <Link href="/">
                  <img src="images/logo-3.png" alt="Logo" title="Visago" />
                </Link>
              </div>
            </div>
